...
const FilterButton = ({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.5}
      className={`${active ? "border-primary" : "border-border"} mr-2 flex-row items-center gap-x-2 rounded-full border px-4 py-2`}
    >
      ...
      <Text className="font-inter-medium text-sm">{label}</Text>
